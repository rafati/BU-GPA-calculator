...
export default function TestDisclaimerEndpoint() {
  ...
  useEffect(() => {
    async function fetchDisclaimer() {
      try {
        ...
        setError(err.message || 'Failed to fetch disclaimer');
  ...
  return (
    <div className="p-8">
      <h1 className="text-2xl font-bold mb-4">Regular Disclaimer API Test</h1>
      ...
      {isLoading ? (
        ...
        <div className="mt-4">
          <h2 className="text-xl font-semibold mb-2">Disclaimer Text:</h2>
